...
public extension AXValue {
	...
	///
	/// If the type is not recognized, this property returns [`AXValueType.illegal`](https://developer.apple.com/documentation/applicationservices/axvaluetype/illegal) .
